                    ...
                    GestureDetector(
                      onTap: () async {
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(
                            builder: (context) => LoadingScreen(fromPage: 'location', cityName: '', ),
                          ),
                        );
                      },
                      child: Image.asset(
                    ...
                    GestureDetector(
                      onTap: () async {
                        ...
                        if (selectedCity != null) {
                          // Call a method to fetch weather data for the selected city
                         // locationWeather:getCityWeather2(selectedCity);
